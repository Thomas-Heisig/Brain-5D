...
def patch_followup() -> None:
    ...
    text = text.replace("_probe_response(\n                    probe_config, initial_weights\n                )", "probe_learning_response(\n                    probe_config, initial_weights\n                )")
...
def patch_workflow() -> None:
    ...
    text = text.replace("from types import CodeType, ModuleType\n", "from types import CodeType, ModuleType\n")
    text = text.replace(
    ...
    text = text.replace(
        ...
        '''        runner_source = cast(str, runner_module.__file__)''',
    )
    text = text.replace(

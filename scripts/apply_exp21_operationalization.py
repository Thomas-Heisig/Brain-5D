...
def main() -> None:
    append_once(ROOT / "research/registry/questions.yaml", "- id: RQ-REC-001", QUESTION_APPEND)
    append_once(ROOT / "research/registry/hypotheses.yaml", "- id: H-REC-001-A", HYPOTHESIS_APPEND)
    patch_assistant()
    patch_workflow()

# EXP-GEN-0019: Wissenschaftliche Zusammenfassung
...
- Tatsächlich ausgeführte Ticks je Lauf: `100000 .. 100000`
...
- Git Commit: `df5e7e98a9b99fdc6d66f21838b69e126f196260`
- Git dirty: `True`
- Runtime: `229.48992590000853` s
...
- `fast`: Referenzvergleiche=299994; discrepancy mean=2.62576e-05, max=0.952011.
- `medium`: Referenzvergleiche=299988; discrepancy mean=3.78343e-05, max=1.15894.
- `slow`: Referenzvergleiche=299982; discrepancy mean=4.61094e-05, max=1.17842.
...
AIRR-Fehler: `HTTP Error 500: Internal Server Error`. Die deterministische Datenauswertung oben bleibt davon unberuehrt.

...
Ein Decoder darf nur Felder erhalten, die in der `ExperimentSpec` freigegeben sind. Insbesondere können `stimulus_id`, Zielklasse, Rewardlabel oder Dateiname ungewollt die Antwort verraten. Brain-5D soll eine automatische Feature-Allowlist und Leakage-Tests verwenden.
...
$$\text{Language Organ} ≢ \text{Brain-5D Core}.$$**\[E0 \| ARCHITECTURE-SPEC\]** Jede wissenschaftliche Behauptung über SNN-Kompetenz muss mit einem NullLanguageBackend oder einer anderen geeigneten Ablation prüfbar bleiben.
...
Provenienz ist Information über Entitäten, Aktivitäten und Akteure, die an der Erzeugung oder Transformation eines Artefakts beteiligt sind ([Buneman et al., 2001](section-045.md#ref-Buneman2001); [Moreau et al., 2013](section-045.md#ref-Moreau2013)). Brain-5D verwendet mindestens:

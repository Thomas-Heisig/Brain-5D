...
Das Fremdpsychische-Problem ist damit nicht erledigt, sondern in seiner Wirkung auf das Design präzisiert. Philosophische Zombies bezeichnen in dieser Debatte einen Grenzfall gleichen äußeren Funktionierens ohne vorausgesetztes Erleben. Das Chinese-Room-Argument problematisiert insbesondere die Beziehung zwischen formaler Symbolverarbeitung und Verständnis. Beide sind philosophische Argumentationsfiguren, keine schon durchgeführten Tests am Brain-5D-Netz. Ihre Übertragung setzt eigene Prämissen voraus.

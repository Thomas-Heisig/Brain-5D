...
Ein Digital Twin wird häufig als gekoppelte digitale Repräsentation eines physischen oder technischen Gegenstands verstanden; Literatur unterscheidet zudem Digital Model, Digital Shadow und Digital Twin nach Kopplungsrichtung und Automatisierungsgrad ([Fuller et al., 2020](section-045.md#ref-Fuller2020); [Jones et al., 2020](section-045.md#ref-Jones2020); [Kritzinger et al., 2018](section-045.md#ref-Kritzinger2018)). Solange Brain-5D primär eine digitale Simulation ohne synchrones physisches Gegenstück ist, ist **Digital State Twin** beziehungsweise **reproduzierbarer digitaler Zustandszwilling** präziser. Wird später ein physisches neuronales Substrat gekoppelt, muss die Twin-Beziehung separat definiert werden.

<a id="b5d-schichtenmodell"></a>

### Schichtenmodell

![Schichten des Brain-5D Storage- und Digital-State-Twin-Konzepts.](../2026-09-07_ki-die-geliehene-intelligenz/abbildungen/K1_image3.png)

Abbildung 7. Schichten des Brain-5D Storage- und Digital-State-Twin-Konzepts.
...
Synapsen können als CSR/CSC-nahe Strukturen, Edge-Chunks oder regional partitionierte Adjazenzlisten gespeichert werden. HDF5-artige Chunk- und Dataset-Konzepte sind für große wissenschaftliche Arrays etabliert ([Folk et al., 2011](section-045.md#ref-Folk2011)); Brain-5D bleibt backend-agnostisch und kann Zarr-, HDF5-, Parquet- oder spezialisierte Graphspeicher kombinieren.
...
Jeder wissenschaftlich relevante Lauf enthält mindestens:
    ...
    run_id: RUN-...
    claim_ids: [CLAIM-...]
    git_repository: Thomas-Heisig/Brain-5D
    git_commit: "..."
    brain5d_version: "..."

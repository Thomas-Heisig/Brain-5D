...
Brain-5D sollte keine zentrale Hypothese von einem einzigen Neuronenmodell abhängig machen. LIF, AdEx und Izhikevich bilden unterschiedliche Kompromisse zwischen Rechenaufwand und dynamischer Vielfalt ([Brette & Gerstner, 2005](section-045.md#ref-Brette2005); [Gerstner et al., 2014](section-045.md#ref-Gerstner2014); [Izhikevich, 2003](section-045.md#ref-Izhikevich2003)). Für ausgewählte Benchmarks ist deshalb eine Modellablation vorzusehen.

...
function ensureReviewLink() {
  ...
  const panel = document.createElement("section"); panel.id = "mhrn-review-share"; panel.className = "mhrn-review-share card"; panel.dataset.mhrnRoute = "science:experiments"; panel.hidden = true;
  ...
  const host = document.getElementById("research-panel-experiments") || workspace; host.appendChild(panel);
}

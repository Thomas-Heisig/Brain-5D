...
function ensurePanel() {
  ...
  panel = document.createElement("section"); panel.id = "mhrn-science-transparency"; panel.className = "mhrn-science-transparency card"; panel.dataset.mhrnRoute = "science:observatory"; panel.hidden = true;

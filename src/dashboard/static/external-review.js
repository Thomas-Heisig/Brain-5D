...
export function initExternalReview() {
  ...
  panel.querySelector("#external-review-method").addEventListener("click",()=>{document.dispatchEvent(new CustomEvent("brain5d:open-file",{detail:{source:"research",path:"external_review/INTEGRATION.md"}}));window.MHRNWorkspaceArchitecture?.selectRoute?.("files","browse");});

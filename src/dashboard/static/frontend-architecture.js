...
function ensureRuntimeCapabilityBoard() {
  ...
  board.innerHTML = `
    ...
    <div class="runtime-capability-grid">
      ...
      <article class="runtime-capability-card"><header><h3>Profile & Identität</h3><span class="maturity-state implemented">implemented</span></header><ul><li>Versioniertes technisches Profil mit Neural Core, Learning, Sinnen, Aktoren, Morphologie, Gateway, Memory, Resources und Safety.</li><li>Save / Load / Save As / Revisionen / Lineage / Snapshot-Bindung / Import / Export: implementiert.</li><li>Autonome Identitätsmutation: <span class="not-implemented-yet">locked / future research</span>.</li></ul></article>

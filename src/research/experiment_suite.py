...
def _network(
    ...
    *,
    ...
    if random_graph:
        network.connect(
            neurons[0], neurons[2], impulse_weight, 1, config=impulse_synapse_config
        )
        network.connect(
        ...
        network.connect(
            neurons[0], neurons[1], impulse_weight, 1, config=impulse_synapse_config
        )
        network.connect(
            neurons[1], neurons[2], impulse_weight, 1, config=impulse_synapse_config
        )
    if recurrence:
        network.connect(
